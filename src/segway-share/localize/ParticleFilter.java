...
public abstract class ParticleFilter
{
                          ...
                          int numClouds)
    {
        ...
        viewedEstimate = new Particle(scene.distCfg().length);
    }
    ...
    protected final MotionConfig mcfg() { return mcfg; }
    
    /** @return scene model */
    protected final SceneModel scene() { return scene; }
    
    /** @return all particle clouds */
    protected final ParticleCloud[] clouds() { return clouds; }
    ...
    /** Set the "p" particle's thetaL/R attributes based on the "yaw". */
    public Particle setYaw(Particle p, double yaw)
    {
