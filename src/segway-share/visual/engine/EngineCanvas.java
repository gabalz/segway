...
{
    public EngineCanvas(ViewConfig cfg, SceneModel scene)
    ...
    public final ViewConfig cfg() { return cfg; }
    public final SceneModel scene() { return scene; }
    ...
    /** Print an openGL error if there is any. */
    public static void glPrintError(String id)
    {
        int errorCode = GL11.glGetError();
        if (0 != errorCode)
        {
            System.err.println("OpenGL error (" + id + "): " + errorCode
