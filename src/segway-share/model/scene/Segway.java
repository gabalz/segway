 ...
 */
public final class Segway extends AbstractSceneModelObject
{
    ...
    public double bodyHeight() { return bodyHeight; }
    ...
    private final double wheelRadius, wheelWidth, bodyWidth, bodyHeight;
