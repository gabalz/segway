...
public class SimConfig extends Config
{
    ...
    throws IOException, MissingConfigException
    {
        ...
        groundHitExit = getBooleanConfig("ground-hit-exit");
    ...
    /** @return if true, simulation ends when the robot hits the ground */
    public boolean isGroundHitExit() { return groundHitExit; }
    ...
    private final boolean groundHitExit;
